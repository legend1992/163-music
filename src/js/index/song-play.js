  ...
  let view = {
    ...
    template: `
      ...
      <footer class="clearfix">
        <button class="left">打开</button>
        <button class="right">下载</button>
      </footer>
    `,
    render(songInfo) {
      let html = this.template;
      let { cover_url, name, lyrics } = songInfo;
      html = html.replace(`{{name}}`, name).replace(`{{lyrics}}`, lyrics).replace(/{{cover_url}}/g, cover_url);
      this.el.html(html)
    }
  };
  let model = {
